...
/**
 * Clase Validaciones
 * Contiene métodos estáticos para validar campos de formularios.
 * Utiliza la librería 'validator' para asegurar formatos correctos.
 */
class Validaciones {
    // Validación de email
    ...
    static validarNombre(nombre) {
        ...
        else if (!validator.isLength(nombre.trim(), { min: 2, max: 50 })) return 'Mínimo 2 caracteres y máximo 50';
        else return true;
    }
    ...
    static validarDireccion(direccion) {
        ...
        else if (!validator.isLength(direccion.trim(), { min: 2, max: 50 })) return 'Mínimo 2 caracteres y máximo 50';
        else return true;
    }
    ...
    static validarImagen(urlImagen) {
        ...
        else if (!validator.isURL(urlImagen.trim())) return 'URL de imagen no válida';
        else return true;
    }
